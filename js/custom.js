...
function mainmenu() {
	...
	if($('.main-menu li.dropdown ul').length){
		//$('.main-menu li.dropdown').prepend('<div class="dropdown-btn"></div>');
		
		//Dropdown Button
		//$('.main-menu li.dropdown .dropdown-btn').on('click', function() {
		//	$(this).next('ul').slideToggle(500);
		//});
		$('.main-menu li.dropdown .dropdown-toggle').on('click', function() {
			$(this).next('ul').slideToggle(500);
		});
	}
...
//===Header Sticky=== REMOVED TO SHOW NAV ON MOBILE ALL THE TIME
...
function equipmentHero() {
    $('.category-selector button').on('click', function() {
        ...
        $(target).removeClass('hide-class');
        $(target).addClass('show-class');
        $(target).siblings().addClass('hide-class');
    });
    $('.subcategory-powered .eqt-class').on('click', function() {
        var target = '#' + $(this).attr('target');
        $(target).removeAttr('class');
        $(target).addClass('container eqt eqt-show');
        $(target).siblings().removeAttr('class');
        $(target).siblings().addClass('container eqt eqt-hide');
